...
def build_info_lines(stats: dict, uptime: str) -> list[str]:
    """Build the right-side info panel. Edit this to customize your profile."""
    return [
        "─────────────────────── faysalahmmed ──────────────────────────",
        "OS:                       Human",
        f"Uptime:                  {uptime}",
        ...
        "Frameworks.Backend:       Node.js, NestJS, REST APIs, Docker",
        "Frameworks.Frontend:      React.js, Tailwind CSS",
        "Database:                 PostgreSQL, MySQL, Redis",
        "",
        "Research.AI:              Multimodal AI, Computer Vision,",
        ...
        "",
        "Education.Latest:         BSc in CSE (2026)",
        ...
        f"GitHub LOC:               {stats['additions'] + stats['deletions']:,} ( +{stats['additions']:,}, -{stats['deletions']:,} )",
        "Research Years:            2+",
        "Publications:              9",
        "Q1 + Q2 Papers:            5",
